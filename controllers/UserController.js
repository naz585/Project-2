...
async function sendEmailConfirmation(req, token) {
    const data = {
        from: 'goatvoter Email Confirmation <me@samples.mailgun.org>',
        to: req.body.email,
        subject: '✔ Reset your password on goatvoter.org',
        text: `Confirm your email address to complete your goatvoter account associated with the email ${
            req.body.email
...
exports.sendPasswordReset = async (req, res) => {
    try {
        ...
        const data = {
            from: 'goat voter Password Reset <me@samples.mailgun.org>',
            to: req.body.email,
            subject: '✔ Reset your password on goatvoter.org',
            text:
